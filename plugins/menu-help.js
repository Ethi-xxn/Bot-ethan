            ...
            },
{
    ...
    await conn.sendListB(m.chat, menu, txt, `𝗠𝗘𝗡𝗨𝗦 𝗚𝗘𝗡𝗘𝗦𝗜𝗦`, [vid, img, img2, img3, img4, img5, img6, img8, img9, img10, img11].getRandom(), listSections]], null, [['CANAL 🐈‍⬛', `${canal}`]], fcontact);
};
